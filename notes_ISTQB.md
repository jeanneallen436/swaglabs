...
**test procedure:** test script, sequences of test cases in execution order  
...
**non-functional testing**: compliance with reqs like performance, usability, cross-compatability, etc...  
